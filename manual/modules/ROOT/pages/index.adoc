...
See link:https://opencpn.org/wiki/dokuwiki/doku.php?id=opencpn:opencpn_user_manual:plugins:install_and_enable[
Install and Enable] page for installing this plugin.
...
* link:https://opencpn.org/wiki/dokuwiki/doku.php?id=opencpn:supplementary_software:polauto[Polauto (Windows)]
